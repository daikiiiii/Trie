		...
		while (ptr != null) {
			...
			if (prefix.charAt(ptr.substr.startIndex) == allWords[ptr.substr.wordIndex].charAt(ptr.substr.startIndex)) {
				...
				for (int i = ptr.substr.startIndex; i <= ptr.substr.endIndex; i++) {
					...
					//if it is equal, but haven't reached the end of the prefix, go to the child
					//if it is equal, and are at the end of the prefix, move to the firstChild and recursive 
